...
// ================================================================ 
  ...
  Future<int> removeObjective(int id) async {
    var db = await database;
    int resultat =
        await db.rawDelete('DELETE FROM $tableObjectives WHERE $colObjectiveId = $id');
    return resultat;
  }
  ...
  Future<List<Objective>> getObjectiveList() async {
    List<Objective> objectiveObjectList = List<Objective>();
    ...
    objectiveObjectList =
        objectiveMapList.map((oneMap) => Objective.fromMapToObject(oneMap)).toList();
...
// ================================================================ 
  ...
  Future<int> removeCategorie(int id) async {
    var db = await database;
    int resultat =
        await db.rawDelete('DELETE FROM $tableCategories WHERE $colCategorieId = $id');
    return resultat;
  }
  ...
  Future<List<Categorie>> getCategorieList() async {
    List<Categorie> categorieObjectList = List<Categorie>();
    var categorieMapList = await getCategoriesMapList(); 
    categorieObjectList = categorieMapList.map((oneMap) => Categorie.fromMapToObject(oneMap)).toList();
...
// ================================================================ 
  ...
  Future<int> removeExercice(int id) async {
    var db = await database;
    int resultat =
        await db.rawDelete('DELETE FROM $tableExercices WHERE $colExerciceId = $id');
    return resultat;
  }
  ...
  Future<List<Exercice>> getExerciceList() async {
    List<Exercice> exerciceObjectList = List<Exercice>();
    var exerciceMapList = await getExercicesMapList();
    exerciceObjectList =
        exerciceMapList.map((oneMap) => Exercice.fromMapToObject(oneMap)).toList();
